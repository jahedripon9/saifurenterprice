    ...
    <div className=" container mx-auto my-10">
      ...
      <div className="flex flex-wrap justify-center gap-3 ">
        <div className="card bg-base-100 w-96 shadow-xl">
          <figure>
            <img src={india} alt="travel" />
          </figure>
          <div className="card-body">
            <h2 className="card-title justify-center text-2xl">India</h2> <hr />
            <p className="text-center font-semibold">
              8 Days 7 Nights Kalimpong- Darjeeling- Pelling- Gangtok
            </p>
        ...
        <div className=" card bg-base-100 w-96 shadow-xl">
          <figure>
            <img src={srilanka} alt="travel" />
          </figure>
          <div className="flex card-body">
            <h2 className="card-title justify-center text-2xl">Srilanka</h2> <hr />
            <p className="text-center font-semibold">
              India 6 Days 5 Nights Kandy- Bentota- Colombo
            </p>
            <div className="card-actions justify-center">
              <button className="  ">
                <SrilankaModal></SrilankaModal>
              </button>
            </div>
          </div>
        </div>
